...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    strsum = str(3**(player_score+opponent_score))
    if strsum[0] == strsum[len(strsum)-1]:
        return True
    else:
        return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            currpoint0 = take_turn(rolls0, score1, dice)
            score0 += currpoint0
            if abs(prevpoint0-rolls0) == 2 and feral_hogs:
                score0 += 3
            prevpoint0 = currpoint0
        else:
            rolls1 = strategy1(score1, score0)
            currpoint1 = take_turn(rolls1, score0, dice)
            score1 += currpoint1
            if abs(prevpoint1-rolls1) == 2 and feral_hogs:
                score1 += 3
...
def make_averaged(g, num_samples=1000):
    ...
    3.0
    """
    # function defined within takes args produced by g and return the avg val
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def avg(*args):
        sum = 0
